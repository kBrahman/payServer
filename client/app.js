...
.then(response => response.json())
  .then(json => {
    ...
    script.src = `https://www.paypal.com/sdk/js?client-id=${json.id}&components=buttons&enable-funding=venmo,paylater`;
...
.Buttons({
  ...
  async createOrder() {
    try {
      ...
      console.log('ceate order resp:' + JSON.stringify(orderData))
      if (orderData.id) {
